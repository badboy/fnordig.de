...
published_date: "2021-07-19 18:00:00 +0200"
layout: post.liquid
data:
  route: blog
  tags:
...
By now it grew to a sizable code base with a lot of functionality beyond just storing some metric data.
...
[Over the past year we've been busy][fog-report] to get Gecko to use Glean through the Rust crate to build its own telemetry on top.
...
[datablog]: https://blog.mozilla.org/data/FIXME
